  ...
  return (
    <div className="text-white text-center text-2xl">
      <p >¿Como Utilizar<strong> FEYMAN</strong>?</p><br />
        ...
        <img src="/src/assets/imgs/tec/fetman2.png" alt="Pasos Pomodoro" className="mx-auto" /> <br />
        <p >2. Tendras la oportunidad de autoeducarte ya que cuentas con la opción de grabarte.</p>
        <img src="/src/assets/imgs/tec/Feyman1.png" alt=" Pasos Pomodoro" className="mx-auto" /><br />
        ...
        <img src="/src/assets/imgs/tec/Feyman3.png" alt="Pasos Pomodoro" className="mx-auto" /><br />
        <p >4. Una vez que hayas terminado la grabación podrás ver una previzualización antes de que descargues el video</p>
        <img src="/src/assets/imgs/tec/Feyman4.png" alt="Pasos Pomodoro" className="mx-auto" />
    </div>
  )
}
