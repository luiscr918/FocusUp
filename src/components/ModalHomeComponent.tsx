...
<ul className="space-y-4">
  ...
  <li className="flex items-center cursor-pointer" onClick={() => /*abrirModalCristopher*/("feynman")}>
    <img src="https://img.icons8.com/ios/50/book.png" alt="Feynman" className="w-7 h-7 mr-4" />
    Feynman
  </li>
  <li className="flex items-center cursor-pointer" onClick={() => /*abrirModalCristopher*/("cornell")}>
    <img src="https://cdn-icons-png.flaticon.com/512/4696/4696551.png" alt="Cornell" className="w-7 h-7 mr-4" />
    Cornell
  </li>
  <li className="flex items-center cursor-pointer" onClick={() => /*abrirModalCristopher*/("mapas")}>
